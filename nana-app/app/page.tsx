        ...
        <main>
          ...
          <section id="features" className="py-16">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">大学生の学業管理に必要な機能を全て集約</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">課題管理</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">授業視聴管理</h3>
                <p className="text-gray-600">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">マルチデバイス</h3>
                <p className="text-gray-600">
